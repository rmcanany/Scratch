...
Public Class FormVariableInputEditor
    ...
    Dim InputEditorDoctor As New InputEditorDoctor
    ...
    Private Sub TableLayoutPanel1_CellPaint(sender As Object, e As TableLayoutCellPaintEventArgs) Handles TableLayoutPanel1.CellPaint
        ...
        End If
    End Sub
    Private Sub TableLayoutPanel2_CellPaint(sender As Object, e As TableLayoutCellPaintEventArgs) Handles TableLayoutPanel2.CellPaint
        e.Graphics.FillRectangle(Brushes.LightGray, e.CellBounds)
    End Sub
    Private Sub TableLayoutPanel4_CellPaint(sender As Object, e As TableLayoutCellPaintEventArgs) Handles TableLayoutPanel4.CellPaint
        e.Graphics.FillRectangle(Brushes.LightGray, e.CellBounds)
    End Sub
